...
/// <summary>
/// Concrete Builder for Trazabilidad Turnos PDF Reports
/// </summary>
public class ReporteTrazabilidadTurnosPDFConstructor : ReporteConstructor
{
    private readonly ReportesService _reportesService;
    private List<TrazabilidadTurnoReporteDTO> _data;

    public ReporteTrazabilidadTurnosPDFConstructor(ReportesService reportesService)
    ...
    public override async Task BuildData()
    {
        ...
        var pdfBytes = _reportesService.GenerarPDFTrazabilidadTurnos(_data);
