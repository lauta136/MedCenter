...
/// <summary>
/// Concrete Builder for Login Audit Excel Reports
/// </summary>
public class ReporteAuditoriaLoginsExcelConstructor : ReporteConstructor
{
    private readonly ReportesService _reportesService;
    private List<LoginAuditoriaReporteDTO> _loginData;

    public ReporteAuditoriaLoginsExcelConstructor(ReportesService reportesService) 
    ...
    public override async Task BuildData()
    {
        ...
        var excelBytes = _reportesService.GenerarExcelAuditoriaLogins(_loginData);
