...
/// <summary>
/// Concrete Builder for Auditoría de Turnos PDF Reports
/// </summary>
public class ReporteAuditoriaTurnosPDFConstructor : ReporteConstructor
{
    private readonly ReportesService _reportesService;
    private List<TurnoAuditoriaReporteDTO> _auditData;

    public ReporteAuditoriaTurnosPDFConstructor(ReportesService reportesService) 
    ...
    public override async Task BuildData()
    {
        ...
        var pdfBytes = _reportesService.GenerarPDFAuditoriaTurnos(_auditData);
